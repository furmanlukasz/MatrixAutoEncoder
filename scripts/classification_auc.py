...
def parse_args():
    parser = argparse.ArgumentParser(description="Classification using RQA features with AUC evaluation")
    parser.add_argument('--input_csv', type=str, required=True,
                        help='Path to the input CSV file with RQA features')
    parser.add_argument('--output_dir', type=str, default='results/classification_auc',
                        help='Directory to save classification results and plots')
