...
classification:
	cd $(PROJECT_DIR) && $(PYTHON_ENV) scripts/classification.py --input_csv $(PROJECT_DIR)/results/rqa_features_all.csv --output_dir $(PROJECT_DIR)/results/classification

classification_adv:
	cd $(PROJECT_DIR) && $(PYTHON_ENV) scripts/classification_adv.py --input_csv $(PROJECT_DIR)/results/rqa_features_all.csv --output_dir $(PROJECT_DIR)/results/classification_adv

classification_auc:
	cd $(PROJECT_DIR) && $(PYTHON_ENV) scripts/classification_auc.py --input_csv $(PROJECT_DIR)/results/rqa_features_all.csv --output_dir $(PROJECT_DIR)/results/classification_auc
